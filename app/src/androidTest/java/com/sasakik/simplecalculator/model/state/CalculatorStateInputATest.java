 ...
 */
public class CalculatorStateInputATest extends AndroidTestCase {

    // テスト専用サブクラス
    static class CalculatorStateInputAForTest extends CalculatorStateInputA {
    ...
    public void test_processOperator() {
        ...
        target.processOperator(new OperatorAdd(), model);
    ...
    public void test_processDecrement() {
        CalculatorModel model = new CalculatorModel();
        CalculatorStateInputAForTest target = new CalculatorStateInputAForTest(); // ←テスト専用クラス
        model.setStatus(target);
